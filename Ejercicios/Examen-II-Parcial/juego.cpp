/* 3) Copiar los siguientes includes al archivo juego.cpp: */
#include <iostream>
#include <windows.h>
#include <conio.h>
#include <stdlib.h>
...
/* 4) Copiar using namespace std */
using namespace std;



/* 5)Cortar/Pegar las siguientes definiciones a juego.cpp: */
#define ARRIBA 72
#define IZQUIERDA 75
#define ABAJO 80
#define DERECHA 77
...
/* 6) Cortar/Pegar las variables definidas al archivo juego.cpp como ser las int y double */
int Puntos;
int cuerpo[200][2];
int n=1;
int tam = 3;
...
/* 7) Cortar/Pegar todas las funciones excepto la funcion main() desde main.cpp a juego.cpp */
...
void dibujarcuerpo()
{
    // 9) Cambiar el caracter del cuerpo del Snake de "O" a "@"
	for(int i=1; i<tam;i++){
